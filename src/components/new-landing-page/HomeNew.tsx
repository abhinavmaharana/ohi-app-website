...
export default function HomeNew() {
    return (
      <div className="flex flex-col justify-center items-center">
        <div className="px-[20px] lg:px-[50px] text-center mt-[20px] space-y-6">
        ...
        {/* <div className="mt-[20px] lg:-mb-[350px]">
            <div className="flex justify-center space-x-6">
                <Card className="w-[304px] h-[503px] rounded-[8px]">
                    <video></video>
                </Card>
                <Card className="hidden lg:block w-[304px] h-[503px] rounded-[8px]">
                    <video></video>
                </Card>
                <Card className="hidden lg:block w-[304px] h-[503px] rounded-[8px]">
                    <video></video>
