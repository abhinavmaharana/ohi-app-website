...
export default function Renowned() {
  return (
    <div id="earn-new" className='background-renowned'>
                <div className='mt-[50px] md:mt-[10px] lg:mt-0'>
                <div className="px-[20px] lg:px-[50px] text-center pt-[20px] lg:pt-[30px]">
                    <h1 className="items-center text-[32px]  lg:text-[48px] text-[#3BA0FF] md:mt-[230px]  lg:mt-[250px] lg:mb-[20px] leading-normal  poppins-bold">Saga of FAME: Feel the thrill of being recognized wherever you go!</h1>
                </div>
                <div className='flex flex-col lg:flex-row justify-between'>
                    <div className='px-[20px] lg:px-[50px]'>
                        <ul className='grid grid-cols-1 md:grid-cols-2 items-center lg:mt-[50px] md:space-y-1 lg:gap-x-48 xl:gap-4'>
                            <li>
                    ...
                    <div className='lg:flex flex-col md:-mt-[100px] lg:mt-0'>
                        {/* Image */}
                        <div>
                            <img src={HandImg} className='md:h-[400px] lg:h-[500px] md:ml-[565px] lg:ml-56'/>
                        </div>
