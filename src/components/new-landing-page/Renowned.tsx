                        ...
                        <ul className='grid grid-cols-1 lg:grid-cols-2 items-center lg:mt-[50px] lg:gap-x-48 xl:gap-4'>
                            <li>
                                <div className='flex items-center lg:w-[300px] xl:w-auto'>
                                    ...
                                    <h1 className='text-[16px] xl:text-[20px] text-[#3BA0FF] poppins-medium'>Globe Trotter: Café and airport lovers who travel across the globe. </h1>
                                </div>
                            </li>
                            <li>
                                <div className='flex items-center space-x-4 lg:w-[300px] xl:w-auto'>
                                <img src={Badge2} className='w-[140px] h-[140px]' alt="" />
                                    <h1 className='xl:text-[20px] text-[#3BA0FF] poppins-medium'>Cafe star: Love hanging out at your favourite café? You've earned your Café Star Badge!</h1>
                                </div>
                            </li>
                            <li>
                                <div className='flex items-center space-x-4 lg:w-[300px] xl:w-auto'>
                                <img src={Badge3} className='w-[140px] h-[140px]' alt="" />
                                    <h1 className='xl:text-[20px] text-[#3BA0FF] poppins-medium'>VIP: If you've made your mark in the real world, you're a VIP in our eyes!</h1>
                                </div>
                            </li>
                            <li>
                                <div className='flex items-center space-x-4 lg:w-[300px] xl:w-auto'>
                                <img src={Badge4} className='w-[140px] h-[140px]' alt="" />
                                    <h1 className='xl:text-[20px] text-[#3BA0FF] poppins-medium'>Real life hero(Army)</h1>
                                </div>
                            </li>
                            <li>
                                <div className='flex items-center space-x-4 lg:w-[300px] xl:w-auto'>
                                <img src={Badge5} className='w-[140px] h-[140px]' alt="" />
                                    <h1 className='xl:text-[20px] text-[#3BA0FF] poppins-medium'>Real life hero (Dr.)</h1>
                                </div>
                            </li>
                            <li>
                                <div className='flex items-center space-x-4 lg:w-[300px] xl:w-auto'>
                                <img src={Badge6} className='w-[140px] h-[140px]' alt="" />
                                    <h1 className='xl:text-[20px] text-[#3BA0FF] poppins-medium'>Luxury Guru: Premium cafés are their go-to spots for a taste of luxury in every sip!</h1>
                                </div>
                            </li>
                            <li>
                                <div className='flex items-center space-x-4 lg:w-[300px] xl:w-auto'>
                                <img src={Badge7} className='w-[140px] h-[140px]' alt="" />
                                    <h1 className='xl:text-[20px] text-[#3BA0FF] poppins-medium'>Influencer: Whether you’re a lifestyle, tech, or comedy influencer, you deserve this badge!</h1>
                                </div>
                            </li>
                        </ul>
                    </div>
